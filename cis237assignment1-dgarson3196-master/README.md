...
## Description
Console application program takes a winelist from csv and prints it searches through it and adds a record to it.
...
1. CIS 237 inClass 1 was used to help create the array textfile and userinterface.
2. I used a program i wrote from cis 209 to help with the search and the userinterface. 
3. used chapter 4 in the book Visual C# How To Program.
