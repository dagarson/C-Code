...
I used some of your code and created my own i didnt use to much of my Assignment 1
...
1. i used some DB programs we had made in 275 for some help 
2. this helps with some knowledge on updating https://support.microsoft.com/en-us/help/308507/how-to-update-a-sql-server-database-by-using-the-sqldataadapter-object
3. used inclass for alot of reference 
4. used assignment 4 for help with menu setup
5. mike gave me some tips for the update and using a tostring for formating the output
